...
class college:
    def __init__(self,root):
        ...
        self.root.geometry("1500x800+1+1")
        ...
        self.Middle_image=ImageTk.PhotoImage(file="teacher.jpg")
    ...
    def login(self):
        ...
        #Username textbox
        Entry(login_screen, textvariable=self.username,font=4).place(x=160,y=98)
        #Password Label
    
        
        #Password textbox
        Label(login_screen, text="password :",font=3).place(x=50,y=165)
        #Label for displaying login status[success/failed]
        Entry(login_screen, textvariable=self.password ,show="*",font=4).place(x=160,y=169)
        #Login button
