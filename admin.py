...
class college_admin:
    def __init__(self,root1):
        ...
        Label_branch['value']=("Btech CSE (CSAI)","Btech CSE (CSDS)","Btech CSE (CSIOT)","Btech CSE (CSBS)","Btech CSE (CORE)","B PHARAMA","MBA","BCA")
    ...
    def add_data(self):
        if self.id=="":
            ...
            connection=database.connect(host="localhost",user="root",password="Meraj@123",database="project")
